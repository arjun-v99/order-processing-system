...
8. Before we begin with our app make sure you have logged in. 
- Send a POST request to `http://127.0.0.1:8000/api/login` with `email` and `password` as request data.
